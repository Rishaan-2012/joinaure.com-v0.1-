...
export default function SolopreneurPage({
  ...
  return (
    <div className="min-h-screen bg-white">
          ...
          <div className="grid md:grid-cols-3 gap-12 mb-20">
              ...
              <div className="relative w-full h-64 bg-gray-100 rounded-2xl mb-6 overflow-hidden">
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="relative w-32 h-32">
                    ...
                    <div className="absolute top-4 left-4 w-20 h-16 bg-gray-300 rounded-lg"></div>
                    <div className="absolute top-8 left-8 w-20 h-16 bg-[#d5b36e] rounded-lg"></div>
                    <div className="absolute top-12 left-12 w-20 h-16 bg-gray-800 rounded-lg"></div>
                    {/* Small circle accent */}
            ...
            <div className="scroll-animate">
              <div className="relative w-full h-64 bg-gray-100 rounded-2xl mb-6 overflow-hidden">
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="relative w-32 h-32">
                    {/* Circles and rectangles for planning */}
                    <div className="absolute top-2 left-6 w-12 h-12 bg-gray-300 rounded-full"></div>
                    <div className="absolute top-8 right-4 w-16 h-8 bg-[#d5b36e] rounded-lg transform rotate-12"></div>
                    <div className="absolute bottom-4 left-2 w-20 h-6 bg-gray-800 rounded-lg"></div>
            ...
            <div className="scroll-animate">
              <div className="relative w-full h-64 bg-gray-100 rounded-2xl mb-6 overflow-hidden">
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="relative w-32 h-32">
                    {/* Overlapping rectangles for accounts */}
                    <div className="absolute top-6 left-2 w-24 h-12 bg-gray-300 rounded-lg"></div>
                    <div className="absolute top-10 left-6 w-24 h-12 bg-[#d5b36e] rounded-lg"></div>
                    <div className="absolute top-14 left-10 w-24 h-12 bg-gray-800 rounded-lg"></div>
                  </div>
                </div>
              </div>
          ...
          <div className="grid md:grid-cols-3 gap-12">
            ...
            <div className="scroll-animate">
              <div className="relative w-full h-64 bg-gray-100 rounded-2xl mb-6 overflow-hidden">
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="relative w-32 h-32">
                    {/* Circles and rectangles for retirement/security */}
                    <div className="absolute top-4 left-8 w-16 h-16 bg-gray-300 rounded-full"></div>
                    <div className="absolute top-12 left-4 w-12 h-8 bg-[#d5b36e] rounded-lg"></div>
                    <div className="absolute bottom-6 right-6 w-10 h-10 bg-gray-800 rounded-lg"></div>
                    <div className="absolute bottom-2 left-12 w-4 h-4 bg-white rounded-full"></div>
                  </div>
                </div>
              </div>
            ...
            <div className="scroll-animate">
              <div className="relative w-full h-64 bg-gray-100 rounded-2xl mb-6 overflow-hidden">
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="relative w-32 h-32">
                    {/* Stacked rectangles for documents */}
                    <div className="absolute top-2 left-6 w-20 h-6 bg-gray-300 rounded"></div>
                    <div className="absolute top-8 left-6 w-20 h-6 bg-[#d5b36e] rounded"></div>
                    <div className="absolute top-14 left-6 w-20 h-6 bg-gray-800 rounded"></div>
                    <div className="absolute top-20 left-6 w-20 h-6 bg-gray-400 rounded"></div>
            ...
            <div className="scroll-animate">
              <div className="relative w-full h-64 bg-gray-100 rounded-2xl mb-6 overflow-hidden">
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="relative w-32 h-32">
                    {/* Various shapes for payment interface */}
                    <div className="absolute top-6 left-4 w-24 h-16 bg-gray-300 rounded-lg"></div>
                    <div className="absolute top-10 left-8 w-16 h-8 bg-[#d5b36e] rounded"></div>
                    <div className="absolute bottom-8 left-6 w-8 h-8 bg-gray-800 rounded"></div>
                    <div className="absolute bottom-6 right-4 w-12 h-4 bg-gray-400 rounded"></div>
      ...
      {/* Benefits Section */}
      <section className="py-20" style={{ backgroundColor: "#d3d3d3" }}>
        <div className="max-w-7xl mx-auto px-6">
